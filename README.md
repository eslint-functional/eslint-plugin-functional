...
| [`ts-immutable/no-let`](./docs/rules/no-let.md)                           | Disallow mutable variables                                                 |               :heavy_check_mark:               |                 :heavy_check_mark:                  |               :heavy_check_mark:                |          |                   |
...
| [`ts-immutable/no-conditional-statement`](./docs/rules/no-conditional-statement.md) | Disallow conditional statements (if and switch statements)                       |                                                |                                                     |               :heavy_check_mark:                |          |                   |
...
| [`ts-immutable/no-return-void`](./docs/rules/no-return-void.md)                     | Disallow function that return nothing                                            |                                                |                 :heavy_check_mark:                  |               :heavy_check_mark:                |          | :thought_balloon: |
| [`ts-immutable/functional-parameters`](./docs/rules/functional-parameters.md)       | Enforce functions have functional parameter                                      |                                                |                 :heavy_check_mark:                  |               :heavy_check_mark:                |          |                   |
