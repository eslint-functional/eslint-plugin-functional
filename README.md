...
| Name                                                         | Description                    | 💼                                        | ⚠️  | 🚫  | 🔧  | ❌  |
| :----------------------------------------------------------- | :----------------------------- | :---------------------------------------- | :-- | :-- | :-- | :-- |
| [functional-parameters](docs/rules/functional-parameters.md) | Enforce functional parameters. | ![badge-currying][] ![badge-lite][] ✅ 🔒 |     |     |     |     |
...
| [no-throw-statements](docs/rules/no-throw-statements.md) | Disallow throwing exceptions.                          | ![badge-lite][] ![badge-no-exceptions][] ✅ 🔒 |     |                    |     |     |
| [no-try-statements](docs/rules/no-try-statements.md)     | Disallow try-catch[-finally] and try-finally patterns. | ![badge-no-exceptions][] 🔒                    |     | ![badge-lite][] ✅ |     |     |

### No Mutations

| Name                                                                         | Description                                                     | 💼                                            | ⚠️  | 🚫  | 🔧  | ❌  |
| :--------------------------------------------------------------------------- | :-------------------------------------------------------------- | :-------------------------------------------- | :-- | :-- | :-- | :-- |
| [immutable-data](docs/rules/immutable-data.md)                               | Enforce treating data as immutable.                             | ![badge-lite][] ![badge-no-mutations][] ✅ 🔒 |     |     |     |     |
| [no-let](docs/rules/no-let.md)                                               | Disallow mutable variables.                                     | ![badge-lite][] ![badge-no-mutations][] ✅ 🔒 |     |     | 🔧  |     |
| [prefer-immutable-types](docs/rules/prefer-immutable-types.md)               | Require function parameters to be typed as certain immutability | ![badge-lite][] ![badge-no-mutations][] ✅ 🔒 |     |     | 🔧  |     |
| [prefer-readonly-type](docs/rules/prefer-readonly-type.md)                   | Prefer readonly array over mutable arrays.                      |                                               |     |     | 🔧  | ❌  |
| [type-declaration-immutability](docs/rules/type-declaration-immutability.md) | Enforce the immutability of types based on patterns.            | ![badge-lite][] ![badge-no-mutations][] ✅ 🔒 |     |     | 🔧  |     |

### No Other Paradigms

| Name                                                     | Description                                                                  | 💼                                                  | ⚠️  | 🚫                 | 🔧  | ❌  |
| :------------------------------------------------------- | :--------------------------------------------------------------------------- | :-------------------------------------------------- | :-- | :----------------- | :-- | :-- |
| [no-classes](docs/rules/no-classes.md)                   | Disallow classes.                                                            | ![badge-lite][] ![badge-no-other-paradigms][] ✅ 🔒 |     |                    |     |     |
| [no-mixed-types](docs/rules/no-mixed-types.md)           | Restrict types so that only members of the same kind of are allowed in them. | ![badge-lite][] ![badge-no-other-paradigms][] ✅ 🔒 |     |                    |     |     |
| [no-this-expressions](docs/rules/no-this-expressions.md) | Disallow this access.                                                        | ![badge-no-other-paradigms][] 🔒                    |     | ![badge-lite][] ✅ |     |     |

### No Statements

| Name                                                                 | Description                                    | 💼                                             | ⚠️  | 🚫              | 🔧  | ❌  |
| :------------------------------------------------------------------- | :--------------------------------------------- | :--------------------------------------------- | :-- | :-------------- | :-- | :-- |
| [no-conditional-statements](docs/rules/no-conditional-statements.md) | Disallow conditional statements.               | ![badge-no-statements][] ✅ 🔒                 |     | ![badge-lite][] |     |     |
| [no-expression-statements](docs/rules/no-expression-statements.md)   | Disallow expression statements.                | ![badge-no-statements][] ✅ 🔒                 |     | ![badge-lite][] |     |     |
| [no-loop-statements](docs/rules/no-loop-statements.md)               | Disallow imperative loops.                     | ![badge-lite][] ![badge-no-statements][] ✅ 🔒 |     |                 |     |     |
| [no-return-void](docs/rules/no-return-void.md)                       | Disallow functions that don't return anything. | ![badge-lite][] ![badge-no-statements][] ✅ 🔒 |     |                 |     |     |
