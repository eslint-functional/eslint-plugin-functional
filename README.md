...
| [`ts-immutable/readonly-array`](./docs/rules/readonly-array.md)           | Prefer readonly array over mutable arrays                                 | :heavy_check_mark:                             | :heavy_check_mark:                                  | :heavy_check_mark:                              | :wrench: |              |
